...
#  
#  // In Primary 
#  rman TARGET / CATALOG ruser/ruser@rman_remote
#  
#   RMAN > CONFIGURE RETENTION POLICY TO RECOVERY WINDOW OF 3 DAYS;
#	RMAN > CONFIGURE CONTROLFILE AUTOBACKUP ON;
#	RMAN > CONFIGURE CONTROLFILE AUTOBACKUP FORMAT FOR DEVICE TYPE DISK TO '${BACKUP_DIR}/ctl_%F';
#  
#  ssh 인증작업 선행 필수
...
## tns 부분 반드시 확인
rman target /@milano catalog ruser/ruser@rman_remote << EOF
